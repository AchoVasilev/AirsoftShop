        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZipCode = table.Column<int>(type: "int", maxLength: 9999, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    DealerNumber = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    DeliveryPrice = table.Column<decimal>(type: "decimal(14,2)", precision: 14, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Power = table.Column<double>(type: "float(14)", maxLength: 999, precision: 14, scale: 2, nullable: false),
                    Color = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Weight = table.Column<double>(type: "float(14)", maxLength: 9999, precision: 14, scale: 2, nullable: false),
                    Magazine = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Capacity = table.Column<int>(type: "int", maxLength: 999, nullable: false),
                    Speed = table.Column<int>(type: "int", maxLength: 999, nullable: false),
                    Firing = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Length = table.Column<int>(type: "int", maxLength: 9999, nullable: false),
                    Barrel = table.Column<int>(type: "int", maxLength: 9999, nullable: false),
                    ...
                    Blowback = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Hopup = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Guns_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Guns_Dealers_DealerId",
                        column: x => x.DealerId,
                        principalTable: "Dealers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Guns_SubCategories_SubCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsInWishList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemsInWishList_Guns_GunId",
                        column: x => x.GunId,
                        principalTable: "Guns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItemsInWishList_WishLists_WishListId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Fields_Dealers_DealerId",
                        column: x => x.DealerId,
                        principalTable: "Dealers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemImages_GunId",
                table: "ItemImages",
                column: "GunId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsInWishList_GunId",
                table: "ItemsInWishList",
                column: "GunId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsInWishList_WishListId",
                table: "ItemsInWishList",
                column: "WishListId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Addresses_Dealers_DealerId",
                table: "Addresses",
                column: "DealerId",
                principalTable: "Dealers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Clients_WishLists_WishListId",
                table: "Clients",
                column: "WishListId",
                principalTable: "WishLists",
                principalColumn: "Id",
